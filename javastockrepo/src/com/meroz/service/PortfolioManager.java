...
public class PortfolioManager implements PortfolioManagerInterface {
	 ...
	 */
	@Override
	public void addStock(String symbol) throws StockNotExistException, PortfolioFullException, StockAlreadyExistsException {
		Portfolio portfolio = (Portfolio) getPortfolio();
	...
	private Stock fromDto(StockDto stockDto) {
		...
		if(stockDto.getRecommendation() != null) newStock.setRecommendation(com.meroz.model.Portfolio.ALGO_RECOMMENDATION.valueOf(stockDto.getRecommendation()));
